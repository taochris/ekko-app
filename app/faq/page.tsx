    ...
    <div className="relative min-h-screen overflow-hidden" style={{ background: "#0d0a0f" }}>
      ...
      <nav className="relative z-10 flex items-center justify-between px-8 py-7 md:px-14">
        ...
        <button
          ...
          style={{ background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.08)", color: "rgba(243,227,190,0.88)", fontSize: 12, fontWeight: 600, letterSpacing: "0.16em", textTransform: "uppercase" }}
        >
          ← Retour
        </button>
      </nav>
